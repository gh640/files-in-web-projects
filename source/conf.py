...
# -*- coding: utf-8 -*-
#
# Files used in web projects documentation build configuration file, created by
...
htmlhelp_basename = 'Filesusedinwebprojectsdoc'
...
latex_documents = [
    (master_doc, 'Filesusedinwebprojects.tex', 'Files used in web projects Documentation',
     'Goto Hayato', 'manual'),
]
...
man_pages = [
    (master_doc, 'filesusedinwebprojects', 'Files used in web projects Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Filesusedinwebprojects', 'Files used in web projects Documentation',
     author, 'Filesusedinwebprojects', 'One line description of project.',
     'Miscellaneous'),
]
